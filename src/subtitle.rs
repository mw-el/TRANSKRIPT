...
#[no_mangle]
pub unsafe extern "system" fn Java_dev_transcribe_LiveSubtitleService_initNative(
    env: JNIEnv,
    _class: JClass,
    service: JObject,
) {
...
#[no_mangle]
pub unsafe extern "system" fn Java_dev_transcribe_LiveSubtitleService_cleanupNative(
    _env: JNIEnv,
    _class: JClass,
) {
...
#[no_mangle]
pub unsafe extern "system" fn Java_dev_transcribe_LiveSubtitleService_setUpdateInterval(
    _env: JNIEnv,
    _class: JClass,
...
#[no_mangle]
pub unsafe extern "system" fn Java_dev_transcribe_LiveSubtitleService_pushAudio(
    env: JNIEnv,
    _class: JClass,
